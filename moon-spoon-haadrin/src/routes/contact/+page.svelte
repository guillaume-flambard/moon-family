...
<svelte:head>
	<title>Contact - Moon Spoon</title>
</svelte:head>
...
<section class="bg-white py-16">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
			...
			<div>
				<div class="rounded-2xl shadow-xl p-8 glass-sunset">
					...
					<div class="mt-8 border-t border-gray-200 pt-8">
						<h3 class="mb-4 font-semibold" style="color: var(--blue-dark);">{m.follow_us()}</h3>
			...
			<!-- Map -->
			<div class="h-[600px] overflow-hidden rounded-2xl shadow-xl">
				<iframe
					src={mapEmbedUrl}
					width="100%"
					height="100%"
